use schema VALIDATION_BAP_MRB_11;
...
CREATE OR REPLACE VIEW HEAD_VALIDATION (
  ...
  ARRAY_CONSTRUCT_COMPACT(
    ...
    IFF(PROFILE_VERSION[0] is null, null, IFF(PROFILE_VERSION[0]::string IN ('1.1'), null, 'PROFILE_VERSION_NOT_ALLOWED_VALUE')),
...
CREATE OR REPLACE VIEW SY01_VALIDATION (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  VIOLATIONS
  ...
  ARRAY_CONSTRUCT_COMPACT(
    IFF(RECORD_TYPE is not null AND ARRAY_SIZE(RECORD_TYPE) >= 1, null, 'RECORD_TYPE_REQUIRED'),
    IFF(RECORD_TYPE is null OR ARRAY_SIZE(RECORD_TYPE) <= 1, null, 'RECORD_TYPE_HAS_MULTIPLE_ITEMS'),
    IFF(RECORD_TYPE[0] is null, null, IFF(RECORD_TYPE[0]::string IN ('SY01'), null, 'RECORD_TYPE_NOT_ALLOWED_VALUE')),
...
CREATE OR REPLACE VIEW SY02_01_VALIDATION (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  VIOLATIONS
  ...
  ARRAY_CONSTRUCT_COMPACT(
    IFF(RECORD_TYPE is not null AND ARRAY_SIZE(RECORD_TYPE) >= 1, null, 'RECORD_TYPE_REQUIRED'),
    IFF(RECORD_TYPE is null OR ARRAY_SIZE(RECORD_TYPE) <= 1, null, 'RECORD_TYPE_HAS_MULTIPLE_ITEMS'),
    IFF(RECORD_TYPE[0] is null, null, IFF(RECORD_TYPE[0]::string IN ('SY02.01'), null, 'RECORD_TYPE_NOT_ALLOWED_VALUE')),
    IFF(SUMMARY_RECORD_ID is not null AND ARRAY_SIZE(SUMMARY_RECORD_ID) >= 1, null, 'SUMMARY_RECORD_ID_REQUIRED'),
    IFF(SUMMARY_RECORD_ID is null OR ARRAY_SIZE(SUMMARY_RECORD_ID) <= 1, null, 'SUMMARY_RECORD_ID_HAS_MULTIPLE_ITEMS'),
    IFF(DISTRIBUTION_CHANNEL is null OR ARRAY_SIZE(DISTRIBUTION_CHANNEL) <= 1, null, 'DISTRIBUTION_CHANNEL_HAS_MULTIPLE_ITEMS'),
    IFF(DISTRIBUTION_CHANNEL_DPID is null OR ARRAY_SIZE(DISTRIBUTION_CHANNEL_DPID) <= 1, null, 'DISTRIBUTION_CHANNEL_DPID_HAS_MULTIPLE_ITEMS'),
...
CREATE OR REPLACE VIEW SY04_VALIDATION (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  VIOLATIONS
  ...
  ARRAY_CONSTRUCT_COMPACT(
    IFF(RECORD_TYPE is not null AND ARRAY_SIZE(RECORD_TYPE) >= 1, null, 'RECORD_TYPE_REQUIRED'),
    IFF(RECORD_TYPE is null OR ARRAY_SIZE(RECORD_TYPE) <= 1, null, 'RECORD_TYPE_HAS_MULTIPLE_ITEMS'),
    IFF(RECORD_TYPE[0] is null, null, IFF(RECORD_TYPE[0]::string IN ('SY04'), null, 'RECORD_TYPE_NOT_ALLOWED_VALUE')),
    IFF(SUMMARY_RECORD_ID is not null AND ARRAY_SIZE(SUMMARY_RECORD_ID) >= 1, null, 'SUMMARY_RECORD_ID_REQUIRED'),
    IFF(SUMMARY_RECORD_ID is null OR ARRAY_SIZE(SUMMARY_RECORD_ID) <= 1, null, 'SUMMARY_RECORD_ID_HAS_MULTIPLE_ITEMS'),
    IFF(DISTRIBUTION_CHANNEL is null OR ARRAY_SIZE(DISTRIBUTION_CHANNEL) <= 1, null, 'DISTRIBUTION_CHANNEL_HAS_MULTIPLE_ITEMS'),
    IFF(DISTRIBUTION_CHANNEL_DPID is null OR ARRAY_SIZE(DISTRIBUTION_CHANNEL_DPID) <= 1, null, 'DISTRIBUTION_CHANNEL_DPID_HAS_MULTIPLE_ITEMS'),
...
CREATE OR REPLACE VIEW SY05_VALIDATION (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  VIOLATIONS
  ...
  ARRAY_CONSTRUCT_COMPACT(
    IFF(RECORD_TYPE is not null AND ARRAY_SIZE(RECORD_TYPE) >= 1, null, 'RECORD_TYPE_REQUIRED'),
    IFF(RECORD_TYPE is null OR ARRAY_SIZE(RECORD_TYPE) <= 1, null, 'RECORD_TYPE_HAS_MULTIPLE_ITEMS'),
    IFF(RECORD_TYPE[0] is null, null, IFF(RECORD_TYPE[0]::string IN ('SY05'), null, 'RECORD_TYPE_NOT_ALLOWED_VALUE')),
    IFF(SUMMARY_RECORD_ID is not null AND ARRAY_SIZE(SUMMARY_RECORD_ID) >= 1, null, 'SUMMARY_RECORD_ID_REQUIRED'),
    IFF(SUMMARY_RECORD_ID is null OR ARRAY_SIZE(SUMMARY_RECORD_ID) <= 1, null, 'SUMMARY_RECORD_ID_HAS_MULTIPLE_ITEMS'),
    IFF(DISTRIBUTION_CHANNEL is null OR ARRAY_SIZE(DISTRIBUTION_CHANNEL) <= 1, null, 'DISTRIBUTION_CHANNEL_HAS_MULTIPLE_ITEMS'),
    IFF(DISTRIBUTION_CHANNEL_DPID is null OR ARRAY_SIZE(DISTRIBUTION_CHANNEL_DPID) <= 1, null, 'DISTRIBUTION_CHANNEL_DPID_HAS_MULTIPLE_ITEMS'),
...
CREATE OR REPLACE VIEW AS01_VALIDATION (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  VIOLATIONS
  ...
  ARRAY_CONSTRUCT_COMPACT(
    IFF(RECORD_TYPE is not null AND ARRAY_SIZE(RECORD_TYPE) >= 1, null, 'RECORD_TYPE_REQUIRED'),
    IFF(RECORD_TYPE is null OR ARRAY_SIZE(RECORD_TYPE) <= 1, null, 'RECORD_TYPE_HAS_MULTIPLE_ITEMS'),
    IFF(RECORD_TYPE[0] is null, null, IFF(RECORD_TYPE[0]::string IN ('AS01'), null, 'RECORD_TYPE_NOT_ALLOWED_VALUE')),
    IFF(BLOCK_ID is not null AND ARRAY_SIZE(BLOCK_ID) >= 1, null, 'BLOCK_ID_REQUIRED'),
    IFF(BLOCK_ID is null OR ARRAY_SIZE(BLOCK_ID) <= 1, null, 'BLOCK_ID_HAS_MULTIPLE_ITEMS'),
...
CREATE OR REPLACE VIEW AS02_01_VALIDATION (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  VIOLATIONS
  ...
  ARRAY_CONSTRUCT_COMPACT(
    IFF(RECORD_TYPE is not null AND ARRAY_SIZE(RECORD_TYPE) >= 1, null, 'RECORD_TYPE_REQUIRED'),
    IFF(RECORD_TYPE is null OR ARRAY_SIZE(RECORD_TYPE) <= 1, null, 'RECORD_TYPE_HAS_MULTIPLE_ITEMS'),
    IFF(RECORD_TYPE[0] is null, null, IFF(RECORD_TYPE[0]::string IN ('AS02.01'), null, 'RECORD_TYPE_NOT_ALLOWED_VALUE')),
    IFF(BLOCK_ID is not null AND ARRAY_SIZE(BLOCK_ID) >= 1, null, 'BLOCK_ID_REQUIRED'),
    IFF(BLOCK_ID is null OR ARRAY_SIZE(BLOCK_ID) <= 1, null, 'BLOCK_ID_HAS_MULTIPLE_ITEMS'),
    IFF(RESOURCE_REFERENCE is not null AND ARRAY_SIZE(RESOURCE_REFERENCE) >= 1, null, 'RESOURCE_REFERENCE_REQUIRED'),
    IFF(RESOURCE_REFERENCE is null OR ARRAY_SIZE(RESOURCE_REFERENCE) <= 1, null, 'RESOURCE_REFERENCE_HAS_MULTIPLE_ITEMS'),
...
UNION
SELECT ASSET_ID, LINE_INDEX, RECORD_TYPE, VIOLATIONS FROM SY01_VALIDATION WHERE ARRAY_SIZE(VIOLATIONS) > 0
UNION
SELECT ASSET_ID, LINE_INDEX, RECORD_TYPE, VIOLATIONS FROM SY02_01_VALIDATION WHERE ARRAY_SIZE(VIOLATIONS) > 0
UNION
SELECT ASSET_ID, LINE_INDEX, RECORD_TYPE, VIOLATIONS FROM SY04_VALIDATION WHERE ARRAY_SIZE(VIOLATIONS) > 0
UNION
SELECT ASSET_ID, LINE_INDEX, RECORD_TYPE, VIOLATIONS FROM SY05_VALIDATION WHERE ARRAY_SIZE(VIOLATIONS) > 0
UNION
...
UNION
SELECT ASSET_ID, LINE_INDEX, RECORD_TYPE, VIOLATIONS FROM AS01_VALIDATION WHERE ARRAY_SIZE(VIOLATIONS) > 0
UNION
SELECT ASSET_ID, LINE_INDEX, RECORD_TYPE, VIOLATIONS FROM AS02_01_VALIDATION WHERE ARRAY_SIZE(VIOLATIONS) > 0
UNION
