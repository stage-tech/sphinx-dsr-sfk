use schema %ENV%_DDEX_DSR.VALIDATION_BAP_MRB_12;
...
block_structure_pre1 as (
  ...
  array_to_string(block_structure, '') regexp '((RE01)((AS01.01(MW01.01)*)|AS02.02)+(RE02)*|((AS01.01(MW01.01)*)|AS02.02))((SU01|SU02))+' pass
