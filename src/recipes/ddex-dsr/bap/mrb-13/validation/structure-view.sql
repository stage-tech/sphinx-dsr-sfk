use schema %ENV%_DDEX_DSR.VALIDATION_BAP_MRB_13;
...
block_structure_pre1 as (
  ...
  array_to_string(block_structure, '') regexp '((RE01.02)((AS01.02(MW01.02)*)|AS02.03)+(RE02)*|((AS01.02(MW01.02)*)|AS02.03))((SU01.02|SU02.02))+' pass
...
header_summary_structure_pre1 as (
  select asset_id, block_id, block_structure,
  array_to_string(block_structure, '') regexp 'HEAD(SY01.02|SY02.03|SY03.01|SY04.02|SY05.03|SY12)+FOOT' pass
  from block_structure_pre1
