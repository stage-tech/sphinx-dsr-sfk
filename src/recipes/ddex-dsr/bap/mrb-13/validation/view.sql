...
CREATE OR REPLACE VIEW HEAD_VALIDATION (
  ...
  ARRAY_CONSTRUCT_COMPACT(
    ...
    IFF(PROFILE_VERSION[0] is null, null, IFF(PROFILE_VERSION[0]::string IN ('1.3'), null, 'PROFILE_VERSION_NOT_ALLOWED_VALUE')),
...
CREATE OR REPLACE VIEW SY01_02_VALIDATION (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  VIOLATIONS
  ...
  ARRAY_CONSTRUCT_COMPACT(
    IFF(RECORD_TYPE is not null AND ARRAY_SIZE(RECORD_TYPE) >= 1, null, 'RECORD_TYPE_REQUIRED'),
    IFF(RECORD_TYPE is null OR ARRAY_SIZE(RECORD_TYPE) <= 1, null, 'RECORD_TYPE_HAS_MULTIPLE_ITEMS'),
    IFF(RECORD_TYPE[0] is null, null, IFF(RECORD_TYPE[0]::string IN ('SY01.02'), null, 'RECORD_TYPE_NOT_ALLOWED_VALUE')),
    ...
    IFF(SERVICE_DESCRIPTION is null OR ARRAY_SIZE(SERVICE_DESCRIPTION) <= 1, null, 'SERVICE_DESCRIPTION_HAS_MULTIPLE_ITEMS'),
    IFF(TOTAL_USAGES is not null AND ARRAY_SIZE(TOTAL_USAGES) >= 1, null, 'TOTAL_USAGES_REQUIRED'),
    ...
    IFF(INDIRECT_VALUE is null OR ARRAY_SIZE(INDIRECT_VALUE) <= 1, null, 'INDIRECT_VALUE_HAS_MULTIPLE_ITEMS'),
    IFF(INDIRECT_VALUE[0] is null, null, IFF(INDIRECT_VALUE[0]::string REGEXP '\\d+(\.\\d+)?', null, 'INDIRECT_VALUE_NOT_DECIMAL')),
...
CREATE OR REPLACE VIEW SY02_03_VALIDATION (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  VIOLATIONS
  ...
  ARRAY_CONSTRUCT_COMPACT(
    IFF(RECORD_TYPE is not null AND ARRAY_SIZE(RECORD_TYPE) >= 1, null, 'RECORD_TYPE_REQUIRED'),
    IFF(RECORD_TYPE is null OR ARRAY_SIZE(RECORD_TYPE) <= 1, null, 'RECORD_TYPE_HAS_MULTIPLE_ITEMS'),
    IFF(RECORD_TYPE[0] is null, null, IFF(RECORD_TYPE[0]::string IN ('SY02.03'), null, 'RECORD_TYPE_NOT_ALLOWED_VALUE')),
    IFF(SUMMARY_RECORD_ID is not null AND ARRAY_SIZE(SUMMARY_RECORD_ID) >= 1, null, 'SUMMARY_RECORD_ID_REQUIRED'),
    IFF(SUMMARY_RECORD_ID is null OR ARRAY_SIZE(SUMMARY_RECORD_ID) <= 1, null, 'SUMMARY_RECORD_ID_HAS_MULTIPLE_ITEMS'),
    IFF(DISTRIBUTION_CHANNEL is null OR ARRAY_SIZE(DISTRIBUTION_CHANNEL) <= 1, null, 'DISTRIBUTION_CHANNEL_HAS_MULTIPLE_ITEMS'),
    IFF(DISTRIBUTION_CHANNEL_DPID is null OR ARRAY_SIZE(DISTRIBUTION_CHANNEL_DPID) <= 1, null, 'DISTRIBUTION_CHANNEL_DPID_HAS_MULTIPLE_ITEMS'),
...
CREATE OR REPLACE VIEW SY03_01_VALIDATION (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  VIOLATIONS
  ...
  ARRAY_CONSTRUCT_COMPACT(
    IFF(RECORD_TYPE is not null AND ARRAY_SIZE(RECORD_TYPE) >= 1, null, 'RECORD_TYPE_REQUIRED'),
    IFF(RECORD_TYPE is null OR ARRAY_SIZE(RECORD_TYPE) <= 1, null, 'RECORD_TYPE_HAS_MULTIPLE_ITEMS'),
    IFF(RECORD_TYPE[0] is null, null, IFF(RECORD_TYPE[0]::string IN ('SY03.01'), null, 'RECORD_TYPE_NOT_ALLOWED_VALUE')),
    IFF(SUMMARY_RECORD_ID is not null AND ARRAY_SIZE(SUMMARY_RECORD_ID) >= 1, null, 'SUMMARY_RECORD_ID_REQUIRED'),
    IFF(SUMMARY_RECORD_ID is null OR ARRAY_SIZE(SUMMARY_RECORD_ID) <= 1, null, 'SUMMARY_RECORD_ID_HAS_MULTIPLE_ITEMS'),
    IFF(DISTRIBUTION_CHANNEL is null OR ARRAY_SIZE(DISTRIBUTION_CHANNEL) <= 1, null, 'DISTRIBUTION_CHANNEL_HAS_MULTIPLE_ITEMS'),
    IFF(DISTRIBUTION_CHANNEL_DPID is null OR ARRAY_SIZE(DISTRIBUTION_CHANNEL_DPID) <= 1, null, 'DISTRIBUTION_CHANNEL_DPID_HAS_MULTIPLE_ITEMS'),
    ...
    IFF(FREE_OR_TRIAL_SUBSCRIBERS is not null AND ARRAY_SIZE(FREE_OR_TRIAL_SUBSCRIBERS) >= 1, null, 'FREE_OR_TRIAL_SUBSCRIBERS_REQUIRED'),
    IFF(FREE_OR_TRIAL_SUBSCRIBERS is null OR ARRAY_SIZE(FREE_OR_TRIAL_SUBSCRIBERS) <= 1, null, 'FREE_OR_TRIAL_SUBSCRIBERS_HAS_MULTIPLE_ITEMS'),
    IFF(FREE_OR_TRIAL_SUBSCRIBERS[0] is null, null, IFF(FREE_OR_TRIAL_SUBSCRIBERS[0]::string REGEXP '\\d+(\.\\d+)?', null, 'FREE_OR_TRIAL_SUBSCRIBERS_NOT_DECIMAL')),
    IFF(CURRENCY_OF_TRANSACTION is null OR ARRAY_SIZE(CURRENCY_OF_TRANSACTION) <= 1, null, 'CURRENCY_OF_TRANSACTION_HAS_MULTIPLE_ITEMS'),
    IFF(CURRENCY_OF_TRANSACTION[0] is null, null, IFF(is_currency(CURRENCY_OF_TRANSACTION[0]::string), null, 'CURRENCY_OF_TRANSACTION_NOT_ALLOWED_VALUE')),
    IFF(EXCHANGE_RATE is null OR ARRAY_SIZE(EXCHANGE_RATE) <= 1, null, 'EXCHANGE_RATE_HAS_MULTIPLE_ITEMS'),
    IFF(EXCHANGE_RATE[0] is null, null, IFF(EXCHANGE_RATE[0]::string REGEXP '\\d+(\.\\d+)?', null, 'EXCHANGE_RATE_NOT_DECIMAL')),
...
CREATE OR REPLACE VIEW SY04_02_VALIDATION (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  VIOLATIONS
  ...
  ARRAY_CONSTRUCT_COMPACT(
    IFF(RECORD_TYPE is not null AND ARRAY_SIZE(RECORD_TYPE) >= 1, null, 'RECORD_TYPE_REQUIRED'),
    IFF(RECORD_TYPE is null OR ARRAY_SIZE(RECORD_TYPE) <= 1, null, 'RECORD_TYPE_HAS_MULTIPLE_ITEMS'),
    IFF(RECORD_TYPE[0] is null, null, IFF(RECORD_TYPE[0]::string IN ('SY04.02'), null, 'RECORD_TYPE_NOT_ALLOWED_VALUE')),
    IFF(SUMMARY_RECORD_ID is not null AND ARRAY_SIZE(SUMMARY_RECORD_ID) >= 1, null, 'SUMMARY_RECORD_ID_REQUIRED'),
    IFF(SUMMARY_RECORD_ID is null OR ARRAY_SIZE(SUMMARY_RECORD_ID) <= 1, null, 'SUMMARY_RECORD_ID_HAS_MULTIPLE_ITEMS'),
    IFF(DISTRIBUTION_CHANNEL is null OR ARRAY_SIZE(DISTRIBUTION_CHANNEL) <= 1, null, 'DISTRIBUTION_CHANNEL_HAS_MULTIPLE_ITEMS'),
    IFF(DISTRIBUTION_CHANNEL_DPID is null OR ARRAY_SIZE(DISTRIBUTION_CHANNEL_DPID) <= 1, null, 'DISTRIBUTION_CHANNEL_DPID_HAS_MULTIPLE_ITEMS'),
    ...
    IFF(TOTAL_USAGES_IN_SUB_PERIOD is null OR ARRAY_SIZE(TOTAL_USAGES_IN_SUB_PERIOD) <= 1, null, 'TOTAL_USAGES_IN_SUB_PERIOD_HAS_MULTIPLE_ITEMS'),
    IFF(TOTAL_USAGES_IN_SUB_PERIOD[0] is null, null, IFF(TOTAL_USAGES_IN_SUB_PERIOD[0]::string REGEXP '\\d+', null, 'TOTAL_USAGES_IN_SUB_PERIOD_NOT_INTEGER')),
    IFF(TOTAL_USAGES_IN_REPORTING_PERIOD is null OR ARRAY_SIZE(TOTAL_USAGES_IN_REPORTING_PERIOD) <= 1, null, 'TOTAL_USAGES_IN_REPORTING_PERIOD_HAS_MULTIPLE_ITEMS'),
    IFF(TOTAL_USAGES_IN_REPORTING_PERIOD[0] is null, null, IFF(TOTAL_USAGES_IN_REPORTING_PERIOD[0]::string REGEXP '\\d+', null, 'TOTAL_USAGES_IN_REPORTING_PERIOD_NOT_INTEGER')),
    IFF(CURRENCY_OF_REPORTING is not null AND ARRAY_SIZE(CURRENCY_OF_REPORTING) >= 1, null, 'CURRENCY_OF_REPORTING_REQUIRED'),
    IFF(CURRENCY_OF_REPORTING is null OR ARRAY_SIZE(CURRENCY_OF_REPORTING) <= 1, null, 'CURRENCY_OF_REPORTING_HAS_MULTIPLE_ITEMS'),
    IFF(CURRENCY_OF_REPORTING[0] is null, null, IFF(is_currency(CURRENCY_OF_REPORTING[0]::string), null, 'CURRENCY_OF_REPORTING_NOT_ALLOWED_VALUE')),
    IFF(CURRENCY_OF_TRANSACTION is null OR ARRAY_SIZE(CURRENCY_OF_TRANSACTION) <= 1, null, 'CURRENCY_OF_TRANSACTION_HAS_MULTIPLE_ITEMS'),
...
CREATE OR REPLACE VIEW SY05_03_VALIDATION (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  VIOLATIONS
  ...
  ARRAY_CONSTRUCT_COMPACT(
    IFF(RECORD_TYPE is not null AND ARRAY_SIZE(RECORD_TYPE) >= 1, null, 'RECORD_TYPE_REQUIRED'),
    IFF(RECORD_TYPE is null OR ARRAY_SIZE(RECORD_TYPE) <= 1, null, 'RECORD_TYPE_HAS_MULTIPLE_ITEMS'),
    IFF(RECORD_TYPE[0] is null, null, IFF(RECORD_TYPE[0]::string IN ('SY05.03'), null, 'RECORD_TYPE_NOT_ALLOWED_VALUE')),
    IFF(SUMMARY_RECORD_ID is not null AND ARRAY_SIZE(SUMMARY_RECORD_ID) >= 1, null, 'SUMMARY_RECORD_ID_REQUIRED'),
    IFF(SUMMARY_RECORD_ID is null OR ARRAY_SIZE(SUMMARY_RECORD_ID) <= 1, null, 'SUMMARY_RECORD_ID_HAS_MULTIPLE_ITEMS'),
    IFF(DISTRIBUTION_CHANNEL is null OR ARRAY_SIZE(DISTRIBUTION_CHANNEL) <= 1, null, 'DISTRIBUTION_CHANNEL_HAS_MULTIPLE_ITEMS'),
    IFF(DISTRIBUTION_CHANNEL_DPID is null OR ARRAY_SIZE(DISTRIBUTION_CHANNEL_DPID) <= 1, null, 'DISTRIBUTION_CHANNEL_DPID_HAS_MULTIPLE_ITEMS'),
    ...
    IFF(RIGHTS_TYPE_PERCENTAGE is null OR ARRAY_SIZE(RIGHTS_TYPE_PERCENTAGE) <= 1, null, 'RIGHTS_TYPE_PERCENTAGE_HAS_MULTIPLE_ITEMS'),
    IFF(RIGHTS_TYPE_PERCENTAGE[0] is null, null, IFF(RIGHTS_TYPE_PERCENTAGE[0]::string REGEXP '\\d+(\.\\d+)?', null, 'RIGHTS_TYPE_PERCENTAGE_NOT_DECIMAL')),
    IFF(PARENT_SUMMARY_RECORD_ID is null OR ARRAY_SIZE(PARENT_SUMMARY_RECORD_ID) <= 1, null, 'PARENT_SUMMARY_RECORD_ID_HAS_MULTIPLE_ITEMS')
  )
from %ENV%_DDEX_DSR.UNTYPED_BAP_MRB_13.SY05_03;


CREATE OR REPLACE VIEW SY12_VALIDATION (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  VIOLATIONS
  ...
  ARRAY_CONSTRUCT_COMPACT(
    IFF(RECORD_TYPE is not null AND ARRAY_SIZE(RECORD_TYPE) >= 1, null, 'RECORD_TYPE_REQUIRED'),
    IFF(RECORD_TYPE is null OR ARRAY_SIZE(RECORD_TYPE) <= 1, null, 'RECORD_TYPE_HAS_MULTIPLE_ITEMS'),
    IFF(RECORD_TYPE[0] is null, null, IFF(RECORD_TYPE[0]::string IN ('SY12'), null, 'RECORD_TYPE_NOT_ALLOWED_VALUE')),
    IFF(SUMMARY_RECORD_ID is not null AND ARRAY_SIZE(SUMMARY_RECORD_ID) >= 1, null, 'SUMMARY_RECORD_ID_REQUIRED'),
    IFF(SUMMARY_RECORD_ID is null OR ARRAY_SIZE(SUMMARY_RECORD_ID) <= 1, null, 'SUMMARY_RECORD_ID_HAS_MULTIPLE_ITEMS'),
    IFF(DISTRIBUTION_CHANNEL is null OR ARRAY_SIZE(DISTRIBUTION_CHANNEL) <= 1, null, 'DISTRIBUTION_CHANNEL_HAS_MULTIPLE_ITEMS'),
    IFF(DISTRIBUTION_CHANNEL_DPID is null OR ARRAY_SIZE(DISTRIBUTION_CHANNEL_DPID) <= 1, null, 'DISTRIBUTION_CHANNEL_DPID_HAS_MULTIPLE_ITEMS'),
    ...
    IFF(EXCHANGE_RATE is null OR ARRAY_SIZE(EXCHANGE_RATE) <= 1, null, 'EXCHANGE_RATE_HAS_MULTIPLE_ITEMS'),
    IFF(EXCHANGE_RATE[0] is null, null, IFF(EXCHANGE_RATE[0]::string REGEXP '\\d+(\.\\d+)?', null, 'EXCHANGE_RATE_NOT_DECIMAL')),
    IFF(TOTAL_COST_OF_CONTENT_IN_CURRENCY_OF_REPORTING is null OR ARRAY_SIZE(TOTAL_COST_OF_CONTENT_IN_CURRENCY_OF_REPORTING) <= 1, null, 'TOTAL_COST_OF_CONTENT_IN_CURRENCY_OF_REPORTING_HAS_MULTIPLE_ITEMS'),
    IFF(TOTAL_COST_OF_CONTENT_IN_CURRENCY_OF_REPORTING[0] is null, null, IFF(TOTAL_COST_OF_CONTENT_IN_CURRENCY_OF_REPORTING[0]::string REGEXP '\\d+(\.\\d+)?', null, 'TOTAL_COST_OF_CONTENT_IN_CURRENCY_OF_REPORTING_NOT_DECIMAL')),
    IFF(PERFORMANCE_ROYALTIES_IN_CURRENCY_OF_REPORTING is null OR ARRAY_SIZE(PERFORMANCE_ROYALTIES_IN_CURRENCY_OF_REPORTING) <= 1, null, 'PERFORMANCE_ROYALTIES_IN_CURRENCY_OF_REPORTING_HAS_MULTIPLE_ITEMS'),
    IFF(PERFORMANCE_ROYALTIES_IN_CURRENCY_OF_REPORTING[0] is null, null, IFF(PERFORMANCE_ROYALTIES_IN_CURRENCY_OF_REPORTING[0]::string REGEXP '\\d+(\.\\d+)?', null, 'PERFORMANCE_ROYALTIES_IN_CURRENCY_OF_REPORTING_NOT_DECIMAL'))
  )
from %ENV%_DDEX_DSR.UNTYPED_BAP_MRB_13.SY12;


CREATE OR REPLACE VIEW RE01_02_VALIDATION (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  VIOLATIONS
  ...
  ARRAY_CONSTRUCT_COMPACT(
    IFF(RECORD_TYPE is not null AND ARRAY_SIZE(RECORD_TYPE) >= 1, null, 'RECORD_TYPE_REQUIRED'),
    IFF(RECORD_TYPE is null OR ARRAY_SIZE(RECORD_TYPE) <= 1, null, 'RECORD_TYPE_HAS_MULTIPLE_ITEMS'),
    IFF(RECORD_TYPE[0] is null, null, IFF(RECORD_TYPE[0]::string IN ('RE01.02'), null, 'RECORD_TYPE_NOT_ALLOWED_VALUE')),
    ...
    IFF(RELEASE_CATALOG_NUMBER is null OR ARRAY_SIZE(RELEASE_CATALOG_NUMBER) <= 1, null, 'RELEASE_CATALOG_NUMBER_HAS_MULTIPLE_ITEMS'),
    IFF(RELEASE_ICPN is null OR ARRAY_SIZE(RELEASE_ICPN) <= 1, null, 'RELEASE_ICPN_HAS_MULTIPLE_ITEMS'),
    IFF(RELEASE_ICPN[0] is null, null, IFF(RELEASE_ICPN[0]::string REGEXP '\\d{12,14}', null, 'RELEASE_ICPN_NOT_ALLOWED_PATTERN')),
    IFF(RELEASE_DISPLAY_ARTIST_NAME is not null AND ARRAY_SIZE(RELEASE_DISPLAY_ARTIST_NAME) >= 1, null, 'RELEASE_DISPLAY_ARTIST_NAME_REQUIRED'),
    IFF(RELEASE_DISPLAY_ARTIST_NAME is null OR ARRAY_SIZE(RELEASE_DISPLAY_ARTIST_NAME) <= 1, null, 'RELEASE_DISPLAY_ARTIST_NAME_HAS_MULTIPLE_ITEMS'),
    IFF(RELEASE_DISPLAY_ARTIST_PARTY_ID is null OR ARRAY_SIZE(RELEASE_DISPLAY_ARTIST_PARTY_ID) <= 1, null, 'RELEASE_DISPLAY_ARTIST_PARTY_ID_HAS_MULTIPLE_ITEMS'),
    IFF(RELEASE_DISPLAY_ARTIST_PARTY_ID[0] is null, null, IFF(RELEASE_DISPLAY_ARTIST_PARTY_ID[0]::string REGEXP 'INSI::\\d{16}', null, 'RELEASE_DISPLAY_ARTIST_PARTY_ID_NOT_ALLOWED_PATTERN')),
    IFF(RELEASE_TITLE is not null AND ARRAY_SIZE(RELEASE_TITLE) >= 1, null, 'RELEASE_TITLE_REQUIRED'),
    IFF(RELEASE_TITLE is null OR ARRAY_SIZE(RELEASE_TITLE) <= 1, null, 'RELEASE_TITLE_HAS_MULTIPLE_ITEMS'),
    IFF(RELEASE_SUB_TITLE is null OR ARRAY_SIZE(RELEASE_SUB_TITLE) <= 1, null, 'RELEASE_SUB_TITLE_HAS_MULTIPLE_ITEMS'),
    ...
    IFF(RELEASE_LABEL_NAME is null OR ARRAY_SIZE(RELEASE_LABEL_NAME) <= 1, null, 'RELEASE_LABEL_NAME_HAS_MULTIPLE_ITEMS'),
    IFF(RELEASE_P_LINE is null OR ARRAY_SIZE(RELEASE_P_LINE) <= 1, null, 'RELEASE_P_LINE_HAS_MULTIPLE_ITEMS'),
    IFF(DATA_PROVIDER_NAME is null OR ARRAY_SIZE(DATA_PROVIDER_NAME) <= 1, null, 'DATA_PROVIDER_NAME_HAS_MULTIPLE_ITEMS'),
    IFF(RELEASE_DATE is null OR ARRAY_SIZE(RELEASE_DATE) <= 1, null, 'RELEASE_DATE_HAS_MULTIPLE_ITEMS'),
    IFF(RELEASE_DATE[0] is null, null, 
      ...
      IFF(TRY_TO_DATE(RELEASE_DATE[0]::string, 'YYYY') is not null, null, 'RELEASE_DATE_NOT_DATE'))))
  )
...
CREATE OR REPLACE VIEW AS01_02_VALIDATION (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  VIOLATIONS
  ...
  ARRAY_CONSTRUCT_COMPACT(
    IFF(RECORD_TYPE is not null AND ARRAY_SIZE(RECORD_TYPE) >= 1, null, 'RECORD_TYPE_REQUIRED'),
    IFF(RECORD_TYPE is null OR ARRAY_SIZE(RECORD_TYPE) <= 1, null, 'RECORD_TYPE_HAS_MULTIPLE_ITEMS'),
    IFF(RECORD_TYPE[0] is null, null, IFF(RECORD_TYPE[0]::string IN ('AS01.02'), null, 'RECORD_TYPE_NOT_ALLOWED_VALUE')),
    IFF(BLOCK_ID is not null AND ARRAY_SIZE(BLOCK_ID) >= 1, null, 'BLOCK_ID_REQUIRED'),
    IFF(BLOCK_ID is null OR ARRAY_SIZE(BLOCK_ID) <= 1, null, 'BLOCK_ID_HAS_MULTIPLE_ITEMS'),
    ...
    IFF(RESOURCE_ISRC is null OR ARRAY_SIZE(RESOURCE_ISRC) <= 1, null, 'RESOURCE_ISRC_HAS_MULTIPLE_ITEMS'),
    IFF(RESOURCE_ISRC[0] is null, null, IFF(RESOURCE_ISRC[0]::string REGEXP '[A-Za-z]{2}-?[0-9A-Za-z]{3}-?\\d{2}-?\\d{5}', null, 'RESOURCE_ISRC_NOT_ALLOWED_PATTERN')),
    IFF(RESOURCE_TITLE is not null AND ARRAY_SIZE(RESOURCE_TITLE) >= 1, null, 'RESOURCE_TITLE_REQUIRED'),
    IFF(RESOURCE_TITLE is null OR ARRAY_SIZE(RESOURCE_TITLE) <= 1, null, 'RESOURCE_TITLE_HAS_MULTIPLE_ITEMS'),
    IFF(RESOURCE_SUB_TITLE is null OR ARRAY_SIZE(RESOURCE_SUB_TITLE) <= 1, null, 'RESOURCE_SUB_TITLE_HAS_MULTIPLE_ITEMS'),
    IFF(RESOURCE_DISPLAY_ARTIST_NAME is null OR ARRAY_SIZE(RESOURCE_DISPLAY_ARTIST_NAME) <= 1, null, 'RESOURCE_DISPLAY_ARTIST_NAME_HAS_MULTIPLE_ITEMS'),
    IFF(RESOURCE_DISPLAY_ARTIST_PARTY_ID is null OR ARRAY_SIZE(RESOURCE_DISPLAY_ARTIST_PARTY_ID) <= 1, null, 'RESOURCE_DISPLAY_ARTIST_PARTY_ID_HAS_MULTIPLE_ITEMS'),
    IFF(RESOURCE_DISPLAY_ARTIST_PARTY_ID[0] is null, null, IFF(RESOURCE_DISPLAY_ARTIST_PARTY_ID[0]::string REGEXP 'INSI::\\d{16}', null, 'RESOURCE_DISPLAY_ARTIST_PARTY_ID_NOT_ALLOWED_PATTERN')),
    IFF(RESOURCE_DURATION is null OR ARRAY_SIZE(RESOURCE_DURATION) <= 1, null, 'RESOURCE_DURATION_HAS_MULTIPLE_ITEMS'),
    IFF(RESOURCE_DURATION[0] is null, null, IFF(RESOURCE_DURATION[0]::string REGEXP 'PT((\\d+H)?\\d+M)?\\d+(\.\\d+)?S', null, 'RESOURCE_DURATION_NOT_ALLOWED_PATTERN')),
    ...
    IFF(IS_SUBJECT_TO_OWNERSHIP_CONFLICT is null OR ARRAY_SIZE(IS_SUBJECT_TO_OWNERSHIP_CONFLICT) <= 1, null, 'IS_SUBJECT_TO_OWNERSHIP_CONFLICT_HAS_MULTIPLE_ITEMS'),
    IFF(IS_SUBJECT_TO_OWNERSHIP_CONFLICT[0] is null, null, IFF(RLIKE(IS_SUBJECT_TO_OWNERSHIP_CONFLICT[0]::string, '(true|false|yes|no|y|n|0|1)', 'i'), null, 'IS_SUBJECT_TO_OWNERSHIP_CONFLICT_NOT_BOOLEAN')),
    IFF(LAST_CONFLICT_CHECK is null OR ARRAY_SIZE(LAST_CONFLICT_CHECK) <= 1, null, 'LAST_CONFLICT_CHECK_HAS_MULTIPLE_ITEMS'),
    IFF(LAST_CONFLICT_CHECK[0] is null, null, 
      ...
      IFF(TRY_TO_DATE(LAST_CONFLICT_CHECK[0]::string, 'YYYY') is not null, null, 'LAST_CONFLICT_CHECK_NOT_DATE'))))
  )
from %ENV%_DDEX_DSR.UNTYPED_BAP_MRB_13.AS01_02;


CREATE OR REPLACE VIEW AS02_03_VALIDATION (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  VIOLATIONS
  ...
  ARRAY_CONSTRUCT_COMPACT(
    IFF(RECORD_TYPE is not null AND ARRAY_SIZE(RECORD_TYPE) >= 1, null, 'RECORD_TYPE_REQUIRED'),
    IFF(RECORD_TYPE is null OR ARRAY_SIZE(RECORD_TYPE) <= 1, null, 'RECORD_TYPE_HAS_MULTIPLE_ITEMS'),
    IFF(RECORD_TYPE[0] is null, null, IFF(RECORD_TYPE[0]::string IN ('AS02.03'), null, 'RECORD_TYPE_NOT_ALLOWED_VALUE')),
    IFF(BLOCK_ID is not null AND ARRAY_SIZE(BLOCK_ID) >= 1, null, 'BLOCK_ID_REQUIRED'),
    IFF(BLOCK_ID is null OR ARRAY_SIZE(BLOCK_ID) <= 1, null, 'BLOCK_ID_HAS_MULTIPLE_ITEMS'),
    IFF(RESOURCE_REFERENCE is not null AND ARRAY_SIZE(RESOURCE_REFERENCE) >= 1, null, 'RESOURCE_REFERENCE_REQUIRED'),
    IFF(RESOURCE_REFERENCE is null OR ARRAY_SIZE(RESOURCE_REFERENCE) <= 1, null, 'RESOURCE_REFERENCE_HAS_MULTIPLE_ITEMS'),
    ...
    IFF(RESOURCE_TYPE is null OR ARRAY_SIZE(RESOURCE_TYPE) <= 1, null, 'RESOURCE_TYPE_HAS_MULTIPLE_ITEMS'),
    IFF(RESOURCE_TYPE[0] is null, null, IFF(is_resource_type(RESOURCE_TYPE[0]::string), null, 'RESOURCE_TYPE_NOT_ALLOWED_VALUE')),
    IFF(MUSICAL_WORK_ISWC is null OR ARRAY_SIZE(MUSICAL_WORK_ISWC) <= 1, null, 'MUSICAL_WORK_ISWC_HAS_MULTIPLE_ITEMS'),
    IFF(MUSICAL_WORK_ISWC[0] is null, null, IFF(MUSICAL_WORK_ISWC[0]::string REGEXP 'T\\d{10}', null, 'MUSICAL_WORK_ISWC_NOT_ALLOWED_PATTERN')),
    IFF(IS_MASTER_RECORDING is null OR ARRAY_SIZE(IS_MASTER_RECORDING) <= 1, null, 'IS_MASTER_RECORDING_HAS_MULTIPLE_ITEMS'),
    IFF(IS_MASTER_RECORDING[0] is null, null, IFF(RLIKE(IS_MASTER_RECORDING[0]::string, '(true|false|yes|no|y|n|0|1)', 'i'), null, 'IS_MASTER_RECORDING_NOT_BOOLEAN')),
    IFF(IS_SUBJECT_TO_OWNERSHIP_CONFLICT is null OR ARRAY_SIZE(IS_SUBJECT_TO_OWNERSHIP_CONFLICT) <= 1, null, 'IS_SUBJECT_TO_OWNERSHIP_CONFLICT_HAS_MULTIPLE_ITEMS'),
    IFF(IS_SUBJECT_TO_OWNERSHIP_CONFLICT[0] is null, null, IFF(RLIKE(IS_SUBJECT_TO_OWNERSHIP_CONFLICT[0]::string, '(true|false|yes|no|y|n|0|1)', 'i'), null, 'IS_SUBJECT_TO_OWNERSHIP_CONFLICT_NOT_BOOLEAN')),
...
CREATE OR REPLACE VIEW MW01_02_VALIDATION (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  VIOLATIONS
  ...
  ARRAY_CONSTRUCT_COMPACT(
    IFF(RECORD_TYPE is not null AND ARRAY_SIZE(RECORD_TYPE) >= 1, null, 'RECORD_TYPE_REQUIRED'),
    IFF(RECORD_TYPE is null OR ARRAY_SIZE(RECORD_TYPE) <= 1, null, 'RECORD_TYPE_HAS_MULTIPLE_ITEMS'),
    IFF(RECORD_TYPE[0] is null, null, IFF(RECORD_TYPE[0]::string IN ('MW01.02'), null, 'RECORD_TYPE_NOT_ALLOWED_VALUE')),
    IFF(BLOCK_ID is not null AND ARRAY_SIZE(BLOCK_ID) >= 1, null, 'BLOCK_ID_REQUIRED'),
    IFF(BLOCK_ID is null OR ARRAY_SIZE(BLOCK_ID) <= 1, null, 'BLOCK_ID_HAS_MULTIPLE_ITEMS'),
    ...
    IFF(MUSICAL_WORK_ISWC is null OR ARRAY_SIZE(MUSICAL_WORK_ISWC) <= 1, null, 'MUSICAL_WORK_ISWC_HAS_MULTIPLE_ITEMS'),
    IFF(MUSICAL_WORK_ISWC[0] is null, null, IFF(MUSICAL_WORK_ISWC[0]::string REGEXP '[A-Za-z]{2}[0-9A-Za-z]{3}\\d{7}', null, 'MUSICAL_WORK_ISWC_NOT_ALLOWED_PATTERN')),
    IFF(MUSICAL_WORK_TITLE is not null AND ARRAY_SIZE(MUSICAL_WORK_TITLE) >= 1, null, 'MUSICAL_WORK_TITLE_REQUIRED'),
    IFF(MUSICAL_WORK_TITLE is null OR ARRAY_SIZE(MUSICAL_WORK_TITLE) <= 1, null, 'MUSICAL_WORK_TITLE_HAS_MULTIPLE_ITEMS'),
    IFF(MUSICAL_WORK_SUB_TITLE is null OR ARRAY_SIZE(MUSICAL_WORK_SUB_TITLE) <= 1, null, 'MUSICAL_WORK_SUB_TITLE_HAS_MULTIPLE_ITEMS'),
    IFF(DATA_PROVIDER_NAME is null OR ARRAY_SIZE(DATA_PROVIDER_NAME) <= 1, null, 'DATA_PROVIDER_NAME_HAS_MULTIPLE_ITEMS'),
    IFF(PROPRIETARY_MUSICAL_WORK_ID is null OR ARRAY_SIZE(PROPRIETARY_MUSICAL_WORK_ID) <= 1, null, 'PROPRIETARY_MUSICAL_WORK_ID_HAS_MULTIPLE_ITEMS'),
    IFF(PROPRIETARY_MUSICAL_WORK_ID[0] is null, null, IFF(PROPRIETARY_MUSICAL_WORK_ID[0]::string REGEXP '\.+::\.+', null, 'PROPRIETARY_MUSICAL_WORK_ID_NOT_ALLOWED_PATTERN')),
    IFF(RESOURCE_REFERENCE is null OR ARRAY_SIZE(RESOURCE_REFERENCE) <= 1, null, 'RESOURCE_REFERENCE_HAS_MULTIPLE_ITEMS'),
    IFF(PARENT_LICENSOR_DATA_RECORD_ID is null OR ARRAY_SIZE(PARENT_LICENSOR_DATA_RECORD_ID) <= 1, null, 'PARENT_LICENSOR_DATA_RECORD_ID_HAS_MULTIPLE_ITEMS'),
    IFF(PARENT_MASTER_LIST_ID is null OR ARRAY_SIZE(PARENT_MASTER_LIST_ID) <= 1, null, 'PARENT_MASTER_LIST_ID_HAS_MULTIPLE_ITEMS')
  )
from %ENV%_DDEX_DSR.UNTYPED_BAP_MRB_13.MW01_02;


CREATE OR REPLACE VIEW SU01_02_VALIDATION (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  VIOLATIONS
  ...
  ARRAY_CONSTRUCT_COMPACT(
    IFF(RECORD_TYPE is not null AND ARRAY_SIZE(RECORD_TYPE) >= 1, null, 'RECORD_TYPE_REQUIRED'),
    IFF(RECORD_TYPE is null OR ARRAY_SIZE(RECORD_TYPE) <= 1, null, 'RECORD_TYPE_HAS_MULTIPLE_ITEMS'),
    IFF(RECORD_TYPE[0] is null, null, IFF(RECORD_TYPE[0]::string IN ('SU01.02'), null, 'RECORD_TYPE_NOT_ALLOWED_VALUE')),
    IFF(BLOCK_ID is not null AND ARRAY_SIZE(BLOCK_ID) >= 1, null, 'BLOCK_ID_REQUIRED'),
    IFF(BLOCK_ID is null OR ARRAY_SIZE(BLOCK_ID) <= 1, null, 'BLOCK_ID_HAS_MULTIPLE_ITEMS'),
    IFF(SUMMARY_RECORD_ID is not null AND ARRAY_SIZE(SUMMARY_RECORD_ID) >= 1, null, 'SUMMARY_RECORD_ID_REQUIRED'),
    IFF(SUMMARY_RECORD_ID is null OR ARRAY_SIZE(SUMMARY_RECORD_ID) <= 1, null, 'SUMMARY_RECORD_ID_HAS_MULTIPLE_ITEMS'),
...
CREATE OR REPLACE VIEW SU02_02_VALIDATION (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  VIOLATIONS
  ...
  ARRAY_CONSTRUCT_COMPACT(
    IFF(RECORD_TYPE is not null AND ARRAY_SIZE(RECORD_TYPE) >= 1, null, 'RECORD_TYPE_REQUIRED'),
    IFF(RECORD_TYPE is null OR ARRAY_SIZE(RECORD_TYPE) <= 1, null, 'RECORD_TYPE_HAS_MULTIPLE_ITEMS'),
    IFF(RECORD_TYPE[0] is null, null, IFF(RECORD_TYPE[0]::string IN ('SU02.02'), null, 'RECORD_TYPE_NOT_ALLOWED_VALUE')),
    IFF(BLOCK_ID is not null AND ARRAY_SIZE(BLOCK_ID) >= 1, null, 'BLOCK_ID_REQUIRED'),
    IFF(BLOCK_ID is null OR ARRAY_SIZE(BLOCK_ID) <= 1, null, 'BLOCK_ID_HAS_MULTIPLE_ITEMS'),
    IFF(SUMMARY_RECORD_ID is not null AND ARRAY_SIZE(SUMMARY_RECORD_ID) >= 1, null, 'SUMMARY_RECORD_ID_REQUIRED'),
    IFF(SUMMARY_RECORD_ID is null OR ARRAY_SIZE(SUMMARY_RECORD_ID) <= 1, null, 'SUMMARY_RECORD_ID_HAS_MULTIPLE_ITEMS'),
...
UNION
SELECT ASSET_ID, LINE_INDEX, RECORD_TYPE, VIOLATIONS FROM SY01_02_VALIDATION WHERE ARRAY_SIZE(VIOLATIONS) > 0
UNION
SELECT ASSET_ID, LINE_INDEX, RECORD_TYPE, VIOLATIONS FROM SY02_03_VALIDATION WHERE ARRAY_SIZE(VIOLATIONS) > 0
UNION
SELECT ASSET_ID, LINE_INDEX, RECORD_TYPE, VIOLATIONS FROM SY03_01_VALIDATION WHERE ARRAY_SIZE(VIOLATIONS) > 0
UNION
SELECT ASSET_ID, LINE_INDEX, RECORD_TYPE, VIOLATIONS FROM SY04_02_VALIDATION WHERE ARRAY_SIZE(VIOLATIONS) > 0
UNION
SELECT ASSET_ID, LINE_INDEX, RECORD_TYPE, VIOLATIONS FROM SY05_03_VALIDATION WHERE ARRAY_SIZE(VIOLATIONS) > 0
UNION
SELECT ASSET_ID, LINE_INDEX, RECORD_TYPE, VIOLATIONS FROM SY12_VALIDATION WHERE ARRAY_SIZE(VIOLATIONS) > 0
UNION
SELECT ASSET_ID, LINE_INDEX, RECORD_TYPE, VIOLATIONS FROM RE01_02_VALIDATION WHERE ARRAY_SIZE(VIOLATIONS) > 0
UNION
SELECT ASSET_ID, LINE_INDEX, RECORD_TYPE, VIOLATIONS FROM RE02_VALIDATION WHERE ARRAY_SIZE(VIOLATIONS) > 0
UNION
SELECT ASSET_ID, LINE_INDEX, RECORD_TYPE, VIOLATIONS FROM AS01_02_VALIDATION WHERE ARRAY_SIZE(VIOLATIONS) > 0
UNION
SELECT ASSET_ID, LINE_INDEX, RECORD_TYPE, VIOLATIONS FROM AS02_03_VALIDATION WHERE ARRAY_SIZE(VIOLATIONS) > 0
UNION
SELECT ASSET_ID, LINE_INDEX, RECORD_TYPE, VIOLATIONS FROM MW01_02_VALIDATION WHERE ARRAY_SIZE(VIOLATIONS) > 0
UNION
SELECT ASSET_ID, LINE_INDEX, RECORD_TYPE, VIOLATIONS FROM SU01_02_VALIDATION WHERE ARRAY_SIZE(VIOLATIONS) > 0
UNION
SELECT ASSET_ID, LINE_INDEX, RECORD_TYPE, VIOLATIONS FROM SU02_02_VALIDATION WHERE ARRAY_SIZE(VIOLATIONS) > 0;
