...
CREATE OR REPLACE VIEW SY01_02 (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  SUMMARY_RECORD_ID,
  ...
  try_to_number(INDIRECT_VALUE[0]::string, 38, 8),
...
CREATE OR REPLACE VIEW SY02_03 (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  SUMMARY_RECORD_ID,
...
CREATE OR REPLACE VIEW SY03_01 (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  SUMMARY_RECORD_ID,
  ...
  try_to_number(FREE_OR_TRIAL_SUBSCRIBERS[0]::string, 38, 8),
  IFF(trim(CURRENCY_OF_TRANSACTION[0]::string)='',NULL,CURRENCY_OF_TRANSACTION[0]::string),
  try_to_number(EXCHANGE_RATE[0]::string, 38, 8),
...
CREATE OR REPLACE VIEW SY04_02 (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  SUMMARY_RECORD_ID,
  ...
  try_to_number(TOTAL_USAGES_IN_SUB_PERIOD[0]::string),
  try_to_number(TOTAL_USAGES_IN_REPORTING_PERIOD[0]::string),
  CURRENCY_OF_REPORTING[0]::string,
  IFF(trim(CURRENCY_OF_TRANSACTION[0]::string)='',NULL,CURRENCY_OF_TRANSACTION[0]::string),
  try_to_number(EXCHANGE_RATE[0]::string, 38, 8),
  try_to_number(CONSUMER_PAID_UNIT_PRICE[0]::string, 38, 8),
...
CREATE OR REPLACE VIEW SY05_03 (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  SUMMARY_RECORD_ID,
  ...
  try_to_number(RIGHTS_CONTROLLER_MARKET_SHARE[0]::string, 38, 8),
  IFF(trim(CURRENCY_OF_REPORTING[0]::string)='',NULL,CURRENCY_OF_REPORTING[0]::string),
  IFF(trim(CURRENCY_OF_TRANSACTION[0]::string)='',NULL,CURRENCY_OF_TRANSACTION[0]::string),
  try_to_number(EXCHANGE_RATE[0]::string, 38, 8),
  IFF(trim(SUBSCRIBER_TYPE[0]::string)='',NULL,SUBSCRIBER_TYPE[0]::string),
  COALESCE(TRY_TO_DATE(SUB_PERIOD_START_DATE[0]::string, 'YYYY-MM-DD'),TRY_TO_DATE(SUB_PERIOD_START_DATE[0]::string, 'YYYY-MM'),TRY_TO_DATE(SUB_PERIOD_START_DATE[0]::string, 'YYYY')),
  ...
  CONTENT_CATEGORY[0]::string,
  try_to_number(RIGHTS_TYPE_PERCENTAGE[0]::string, 38, 8),
  IFF(trim(PARENT_SUMMARY_RECORD_ID[0]::string)='',NULL,PARENT_SUMMARY_RECORD_ID[0]::string)
from %ENV%_DDEX_DSR.UNTYPED_BAP_MRB_13.SY05_03;


CREATE OR REPLACE VIEW SY12 (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  SUMMARY_RECORD_ID,
  ...
  IFF(trim(CURRENCY_OF_TRANSACTION[0]::string)='',NULL,CURRENCY_OF_TRANSACTION[0]::string),
  try_to_number(EXCHANGE_RATE[0]::string, 38, 8),
  try_to_number(TOTAL_COST_OF_CONTENT_IN_CURRENCY_OF_REPORTING[0]::string, 38, 8),
  try_to_number(PERFORMANCE_ROYALTIES_IN_CURRENCY_OF_REPORTING[0]::string, 38, 8)
from %ENV%_DDEX_DSR.UNTYPED_BAP_MRB_13.SY12;


CREATE OR REPLACE VIEW RE01_02 (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  BLOCK_ID,
  ...
  PROPRIETARY_RELEASE_ID,
  IFF(trim(RELEASE_CATALOG_NUMBER[0]::string)='',NULL,RELEASE_CATALOG_NUMBER[0]::string),
  IFF(trim(RELEASE_ICPN[0]::string)='',NULL,RELEASE_ICPN[0]::string),
  RELEASE_DISPLAY_ARTIST_NAME[0]::string,
  IFF(trim(RELEASE_DISPLAY_ARTIST_PARTY_ID[0]::string)='',NULL,RELEASE_DISPLAY_ARTIST_PARTY_ID[0]::string),
  RELEASE_TITLE[0]::string,
  IFF(trim(RELEASE_SUB_TITLE[0]::string)='',NULL,RELEASE_SUB_TITLE[0]::string),
  IFF(trim(RELEASE_TYPE[0]::string)='',NULL,RELEASE_TYPE[0]::string),
  IFF(trim(RELEASE_LABEL_NAME[0]::string)='',NULL,RELEASE_LABEL_NAME[0]::string),
  IFF(trim(RELEASE_P_LINE[0]::string)='',NULL,RELEASE_P_LINE[0]::string),
  IFF(trim(DATA_PROVIDER_NAME[0]::string)='',NULL,DATA_PROVIDER_NAME[0]::string),
  COALESCE(TRY_TO_DATE(RELEASE_DATE[0]::string, 'YYYY-MM-DD'),TRY_TO_DATE(RELEASE_DATE[0]::string, 'YYYY-MM'),TRY_TO_DATE(RELEASE_DATE[0]::string, 'YYYY'))
...
CREATE OR REPLACE VIEW AS01_02 (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  BLOCK_ID,
  ...
  IFF(trim(RESOURCE_ISRC[0]::string)='',NULL,RESOURCE_ISRC[0]::string),
  RESOURCE_TITLE[0]::string,
  IFF(trim(RESOURCE_SUB_TITLE[0]::string)='',NULL,RESOURCE_SUB_TITLE[0]::string),
  IFF(trim(RESOURCE_DISPLAY_ARTIST_NAME[0]::string)='',NULL,RESOURCE_DISPLAY_ARTIST_NAME[0]::string),
  IFF(trim(RESOURCE_DISPLAY_ARTIST_PARTY_ID[0]::string)='',NULL,RESOURCE_DISPLAY_ARTIST_PARTY_ID[0]::string),
  IFF(trim(RESOURCE_DURATION[0]::string)='',NULL,RESOURCE_DURATION[0]::string),
  RESOURCE_TYPE[0]::string,
  try_to_boolean(IS_MASTER_RECORDING[0]::string),
  try_to_boolean(IS_SUBJECT_TO_OWNERSHIP_CONFLICT[0]::string),
  COALESCE(TRY_TO_DATE(LAST_CONFLICT_CHECK[0]::string, 'YYYY-MM-DD'),TRY_TO_DATE(LAST_CONFLICT_CHECK[0]::string, 'YYYY-MM'),TRY_TO_DATE(LAST_CONFLICT_CHECK[0]::string, 'YYYY'))
from %ENV%_DDEX_DSR.UNTYPED_BAP_MRB_13.AS01_02;


CREATE OR REPLACE VIEW AS02_03 (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  BLOCK_ID,
  ...
  IFF(trim(RESOURCE_DURATION[0]::string)='',NULL,RESOURCE_DURATION[0]::string),
  RESOURCE_TYPE[0]::string,
  IFF(trim(MUSICAL_WORK_ISWC[0]::string)='',NULL,MUSICAL_WORK_ISWC[0]::string),
  MUSICAL_WORK_COMPOSER_AUTHOR_NAME,
  MUSICAL_WORK_COMPOSER_AUTHOR_PARTY_ID,
  MUSICAL_WORK_ARRANGER_NAME,
  MUSICAL_WORK_ARRANGER_PARTY_ID,
...
CREATE OR REPLACE VIEW MW01_02 (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  BLOCK_ID,
  ...
  IFF(trim(MUSICAL_WORK_ISWC[0]::string)='',NULL,MUSICAL_WORK_ISWC[0]::string),
  MUSICAL_WORK_TITLE[0]::string,
  IFF(trim(MUSICAL_WORK_SUB_TITLE[0]::string)='',NULL,MUSICAL_WORK_SUB_TITLE[0]::string),
  MUSICAL_WORK_COMPOSER_AUTHOR_NAME,
  MUSICAL_WORK_COMPOSER_AUTHOR_PARTY_ID,
  MUSICAL_WORK_ARRANGER_NAME,
  MUSICAL_WORK_ARRANGER_PARTY_ID,
  ...
  MUSICAL_WORK_WORK_CONTRIBUTOR_PARTY_ID,
  IFF(trim(DATA_PROVIDER_NAME[0]::string)='',NULL,DATA_PROVIDER_NAME[0]::string),
  IFF(trim(PROPRIETARY_MUSICAL_WORK_ID[0]::string)='',NULL,PROPRIETARY_MUSICAL_WORK_ID[0]::string),
  IFF(trim(RESOURCE_REFERENCE[0]::string)='',NULL,RESOURCE_REFERENCE[0]::string),
  IFF(trim(PARENT_LICENSOR_DATA_RECORD_ID[0]::string)='',NULL,PARENT_LICENSOR_DATA_RECORD_ID[0]::string),
  IFF(trim(PARENT_MASTER_LIST_ID[0]::string)='',NULL,PARENT_MASTER_LIST_ID[0]::string)
from %ENV%_DDEX_DSR.UNTYPED_BAP_MRB_13.MW01_02;


CREATE OR REPLACE VIEW SU01_02 (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  BLOCK_ID,
...
CREATE OR REPLACE VIEW SU02_02 (
  ASSET_ID,
  LINE_INDEX,
  RECORD_TYPE,
  BLOCK_ID,
